...
<body class="bg-[#0f172a] text-white flex">
    ...
    <main class="flex-1 p-10">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="bg-slate-800/40 border border-slate-700 p-6 rounded-3xl flex justify-between items-center group">
                <div>
                    <h4 class="text-lg font-bold"><?= $p['product_name'] ?></h4>
                    <p class="text-slate-500 text-sm font-mono">Price: $<?= $p['price'] ?> | Available: <?= $p['stock'] ?></p>
                </div>
